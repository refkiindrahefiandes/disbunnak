                        ...
                        <div class="card card-line">
                            <div class="card-header">
                                <div class="card-header-title">
                                    <i class="icon ion-tshirt"></i>Post Slider Plugin
                                </div>
                                <div class="tools">
                                    <div class="btn-group">
...
function addTab() {
    ...
    text +=        '<p>Select post from left box to add to post slider plugin.</p><br>';
    text +=        '<select multiple="multiple" id="multi-select-'+ row +'" class="multi-select" name="post-select['+ row +'][]">';
                   <?php foreach ($post_data as $post) { ?>
    text +=            '<option value="<?php echo $post['blog_id'] ?>"><?php echo htmlentities($post['title'], ENT_QUOTES); ?></option>';
                   <?php } ?>
    text +=        '</select>';
    text +=  '</div>';
