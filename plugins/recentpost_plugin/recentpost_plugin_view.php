                        ...
                        <div class="card card-line">
                            <div class="card-header">
                                <div class="card-header-title">
                                    <i class="icon ion-tshirt"></i>Recent Post
                                </div>
                                <div class="tools">
                                    <div class="btn-group">
                                ...
                                <div id="tab-wrapper" class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="row-<?php echo $row ?>" role="tabpanel" style="padding: 20px">
                                        <div class="form-group">
                                            <input class="form-control" id="limit" name="recentpost[<?php echo $row ?>][limit]" value="<?php echo $recent['limit'] ?>" type="text">
                                            <label for="limit">Post to show</label>
                                        </div>
                                    </div>
                                    <?php $row++; ?>
                                    <?php } ?>
...
function addTab() {
    ...
    text +=          '<input class="form-control" id="limit" name="recentpost['+ row +'][limit]" value="" type="text">';
    text +=          '<label for="limit">Post to show</label>';
    text +=      '</div>';
    text +=  '</div>';
