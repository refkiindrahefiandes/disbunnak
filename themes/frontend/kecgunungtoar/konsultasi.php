<section class="banner_area">
    <div class="container">
        ...
        <div class="pull-right">
            ...
            <a href="<?php echo site_url('konsultasi'); ?>">KONSULTASI</a>
        </div>
    </div>
</section>
...
<section class="contact_form_area2">
    <div class="container">
    <div class="pull-right">
                <a class="more_btn" href="<?php echo site_url('konsultasi/laporan'); ?>">Laporan Konsultasi</a>
            </div>
        <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <?php if (isset($this->session->userdata['success'])) {
                            echo '<div class="alert alert-callout alert-success" role="alert">DATA BERHASIL DIKIRIM,  <a href="'. site_url('konsultasi/laporan') .'">LIHAT PENGADUAN</a><i class="fa fa-remove close" onclick="$(this).parent().remove();"></i></div>';
                        } ?>
                	</div>
                    ...
                    <?php echo form_open('','class="contact_us_form form"'); ?>
                        ...
                        <!-- <div class="form-group col-md-4">
                            <label class="control-label" for="title">Judul Konsultasi<span class="required">*</span></label>
                        ...
                        <div class="form-group col-md-12 <?php if (form_error("content")) { echo 'has-error';  } ?>">
                            <label class="control-label" for="content">Isi <?php echo lang('text_message') ?> Konsultasi <span class="required">*</span></label>
