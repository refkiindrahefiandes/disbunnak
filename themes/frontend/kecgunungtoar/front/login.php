<section class="banner_area">
    <div class="container">
        <div class="pull-left">
            <h3><?php echo lang('title_login') ?></h3>
        </div>
        <div class="pull-right">
            <a href="<?php echo site_url('', TRUE); ?>">Beranda</a>
            <a href="<?php echo site_url('front/login'); ?>"><?php echo lang('title_login') ?></a>
        </div>
    </div>
</section>
                ...
                <div class="row">
                    ...
                    <?php echo form_open('','class="contact_us_form form"'); ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <small><p class="help-block pull-right"><a href="#">Forgotten?</a></p></small>
                        </div>
                        <input type="hidden" name="target_url" value="<?php echo $target_url; ?>">
                        <div class="form-group col-md-12 button_area">
                            <button type="submit" value="submit your quote" class="btn submit_blue form-control" id="js-contact-btn"><?php echo lang('btn_login') ?> <i class="fa fa-angle-right"></i></button>
                            <a type="button" href="<?php echo site_url('front/register') ?>" value="submit your quote" class="btn submit_blue form-control" id="btn-daftar"><?php echo lang('btn_register') ?> <i class="fa fa-angle-right"></i></a>
                        </div>
                    <?php echo form_close();?>
                </div>
            </div>
