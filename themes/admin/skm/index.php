                    ...
                    <div class="col-md-12">
                        <div class="card card-line">
                            <div class="card-header">
                                ...
                                <i class="icon ion-ios-photos"></i>Semua Pertanyaan SKM
                                </div>
                                <div class="tools">
                                    <div class="btn-group">
                                        <a href="<?php echo site_url('admin/skm/edit'); ?>" class="btn btn-primary" role="button"><i class="icon ion-compose"></i> <?php echo lang('btn_add') ?></a>
                                        <a href="<?php echo site_url('admin/skm/penilaian'); ?>" class="btn btn-success" role="button"><i class="icon ion-star"></i> Lihat Penilaian</a>
                            ...
                            <div class="card-body table-responsive">
                                <?php echo form_open('admin/skm/delete','id="form"'); ?>
    ...
    $(function() {
        $('#dataTables').dataTable({
            "fnCreatedRow": function( nRow, aData, iDataIndex ) {
                ...
                button += '<a href="'+baseurl+'admin/skm/delete/'+id+'" class="btn btn-icon-toggle btn-default" data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="icon ion-trash-a"></i></a>';
            ...
            "fnDrawCallback": function( oSettings ) {
                ...
                $('input[name="status"]').on('switchChange.bootstrapSwitch', function(event, state) {
                    $.ajax({
                        url: baseurl + 'admin/skm/status/' + $(this).attr('data') + '/' + state ,
                        dataType: 'json',
            ...
            "bServerSide": true,
            "sAjaxSource": baseurl+"admin/skm/get_datatables"
        });
