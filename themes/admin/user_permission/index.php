                ...
                <div class="row">
                    ...
                    <div class="card card-line">
                        <div class="card-header">
                            ...
                            <div class="tools">
                                <div class="btn-group">
                                    <a href="<?php echo site_url('admin/user/user_permission/edit'); ?>" class="btn btn-primary" role="button"><i class="icon ion-compose"></i> <?php echo lang('btn_add') ?></a>
                        ...
                        <div class="card-body table-responsive">
                            ...
                            <?php echo form_open('admin/user/user_permission/delete','id="form"'); ?>
    ...
    $(function() {
        $('#dataTables').dataTable({
            "fnCreatedRow": function( nRow, aData, iDataIndex ) {
                ...
                button =  '<a href="'+baseurl+'admin/user/user_permission/edit/'+id+'" class="btn btn-icon-toggle btn-default" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i class="icon ion-compose"></i></a>';
                button += '<a href="'+baseurl+'admin/user/user_permission/delete/'+id+'" class="btn btn-icon-toggle btn-default" data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="icon ion-trash-a"></i></a>';
            ...
            "bServerSide": true,
            "sAjaxSource": baseurl+"admin/user/user_permission/get_datatables"
        });
