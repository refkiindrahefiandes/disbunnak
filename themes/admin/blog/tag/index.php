                ...
                <div class="row">
                    ...
                    <div class="card card-line">
                        <div class="card-header">
                            ...
                            <i class="icon ion-ios-paper"></i><?php echo lang('text_all_tags') ?>
                            </div>
                            <div class="tools">
                                <div class="btn-group">
                                    <a href="<?php echo site_url('admin/blog/tag/edit'); ?>" class="btn btn-primary" role="button"><i class="icon ion-compose"></i> <?php echo lang('btn_add') ?></a>
                        ...
                        <div class="card-body table-responsive">
                            <?php echo form_open('admin/blog/tag/delete','id="form"'); ?>
                                ...
                                <table id="dataTables" class="table table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo lang('tbl_title_language') ?></th>
    ...
    $(function() {
        $('#dataTables').dataTable({
            "fnCreatedRow": function( nRow, aData, iDataIndex ) {
                ...
                button =  '<a href="'+baseurl+'admin/blog/tag/edit/'+id+'" class="btn btn-icon-toggle btn-default" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i class="icon ion-compose"></i></a>';
                button += '<a href="'+baseurl+'admin/blog/tag/delete/'+id+'" class="btn btn-icon-toggle btn-default" data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="icon ion-trash-a"></i></a>';
            ...
            "fnDrawCallback": function( oSettings ) {
                ...
                $('input[name="status"]').on('switchChange.bootstrapSwitch', function(event, state) {
                    $.ajax({
                        url: baseurl + 'admin/blog/tag/status/' + $(this).attr('data') + '/' + state ,
                        dataType: 'json',
            ...
            "bServerSide": true,
            "sAjaxSource": baseurl+"admin/blog/tag/get_datatables"
        });
