        ...
        <div class="content-wrap scroll-view">
            ...
            <section class="content-body">
                ...
                <?php echo form_open('','class="form"'); ?>
                    ...
                    <div class="col-md-4">
                        <?php if(!$contact['catatan'] == ''): ?>
                        <div class="card card-line">
							<div class="card-header">
								<div class="card-header-title"><i class="icon ion-checkmark-circled" style="color: #1b7e5a;"></i>Catatan : Admin Pengaduan </div>
								<div class="tools">
									<!-- <div class="btn-group">
										<button type="button" class="btn btn-link" data-toggle='modal' data-target='#lihat_detail'>LIHAT DETAIL</button>
									</div> -->
								</div>
							</div>
                            <div class="card-body tab-content">
                    ...
                    if(in_array($this->user_permission_m->get_user_group_slug(),$allValues, true)): ?>
                            <div class="card-body">
                                ...
                                <div class="form-group">
									<textarea id="textarea-mini" class="form-control" rows="4" name="catatan"></textarea>
...
$(document).ready(function() {
    ...
    tinymce.init({
    	selector: "textarea#textarea-mini",
    	theme: "modern",
    	plugins: [
    		"image, link, code, table, fullscreen"
    	],
		content_css: "<?=ADMIN_ASSETS_URL ?>css/libs/tinymce.content.css",
