    ...
    $(function() {
        $('#dataTables').dataTable({
            "fnCreatedRow": function( nRow, aData, iDataIndex ) {
                ...
                button =  '<a href="'+baseurl+'admin/konsultasi/view/'+id+'" class="btn btn-icon-toggle btn-default" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i class="icon ion-eye"></i></a>';
            ...
            "bServerSide": true,
            "sAjaxSource": baseurl+"admin/konsultasi/get_datatables_arsip"
        });
