                ...
                <div class="row">
                    ...
                    <div class="card card-line">
                        <div class="card-header">
                            ...
                            <i class="icon ion-ios-photos"></i><?php echo lang('text_all_contact') ?>
                            </div>
                            <div class="tools">
                                <div class="btn-group">
    ...
    $(function() {
        $('#dataTables').dataTable({
            "fnCreatedRow": function( nRow, aData, iDataIndex ) {
                ...
                button =  '<a href="'+baseurl+'admin/contact/edit/'+id+'" class="btn btn-icon-toggle btn-default" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i class="icon ion-compose"></i></a>';
                button += '<a href="'+baseurl+'admin/contact/delete/'+id+'" class="btn btn-icon-toggle btn-default" data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="icon ion-trash-a"></i></a>';
            ...
            "bServerSide": true,
            "sAjaxSource": baseurl+"admin/contact/get_datatables"
        });
