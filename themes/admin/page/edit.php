        ...
        <div class="content-wrap scroll-view">
            ...
            <section class="content-body">
                ...
                <div class="row">
                    ...
                    <input type="hidden" name="page_data[page_id]" value="<?php echo $page['page_data']['page_id']; ?>">
                    <div class="col-md-8">
                        <div class="card card-line">
                            <div class="card-header">
                                <div class="card-header-title">
                                    <i class="icon ion-ios-photos"></i><?php echo lang('text_edit_page') ?>
                                </div>
                            ...
                            <div class="card-body tab-content">
                                <?php foreach ($languages as $language) : ?>
                                    <div class="tab-pane <?php if ($language['language_code'] == $language_code) { ?> active <?php } ?>" id="tab-language-<?php echo $language['language_code']; ?>" role="tabpanel">
                                        <div class="form-group <?php if (form_error("page_desc[$language[language_code]][title]")) {
                                                                        echo 'has-error';
                                                                    } ?>">
                                            <input type="text" class="form-control" id="name-<?php echo $language['language_code']; ?>" name="page_desc[<?php echo $language['language_code']; ?>][title]" value="<?php echo $page['page_desc'][$language['language_code']]['title'] ?>">
                                            <label for="name-<?php echo $language['language_code']; ?>"><?php echo lang('text_page_title') ?> <span class="required">*</span></label>
                                            <?php echo form_error("page_desc[$language[language_code]][title]", '<p class="help-block ">', '</p>'); ?>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea name="page_desc[<?php echo $language['language_code']; ?>][description]" id="textarea-<?php echo $language['language_code']; ?>" class="form-control textarea" rows="15"><?php echo $page['page_desc'][$language['language_code']]['description'] ?></textarea>
                        ...
                        <div class="card card-line">
                            ...
                            <div class="card-body">
                                <table id="form-list-images" class="table table-banner">
                                    ...
                                    <tbody>
                                        <?php $image_row = 0; ?>
                                        <?php if (count($page['page_image'])) : foreach ($page['page_image'] as $key => $image) : ?>
                                                <tr>
                                                    <input type="hidden" name="post_image[<?php echo $image_row ?>][page_image_id]" value="<?php echo $image['page_image_id'] ?>" />
                                                    <td>
                    ...
                    <div class="col-md-4">
                        <div class="card card-line">
                            <div class="card-header">
                                <div class="card-header-title">
                                    <i class="icon ion-image"></i><?php echo lang('text_thumbnail') ?>
                                </div>
                            </div>
                            <div class="card-body">
                                <div id="post-thumbnail">
                                    <div class="thumbnail-image">
                                        <a href="" id="thumb-image" data-toggle="image-thumb" style="min-height: 150px; display: block;"><img src="<?php echo $page['page_data']['image_path']; ?>" alt=""></a>
                                        <input type="hidden" name="page_data[image]" value="<?php echo $page['page_data']['image']; ?>" id="input-image" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-line">
                            <div class="card-body">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="sort_order" name="page_data[sort_order]" value="<?php echo $page['page_data']['sort_order']; ?>">
                                    <label for="sort_order"><?php echo lang('text_sort_order') ?></label>
                                </div>
                                <?php if ($publish_permission) : ?>
                                    <div>
                                        <label class="radio-styled">
                                            <input type="radio" name="page_data[status]" class="iCheck" value="1" <?php if ($page['page_data']['status'] == 1) { ?> checked <?php } ?>><span> <?php echo lang('text_publish') ?></span>
                                        </label>
                                        <label class="radio-inline radio-styled">
                                            <input type="radio" name="page_data[status]" class="iCheck" value="0" <?php if ($page['page_data']['status'] == 0) { ?> checked <?php } ?>><span> <?php echo lang('text_unpublish') ?></span>
                                        </label>
                                    </div>
                                <?php endif ?>
                            </div>
                            ...
                            <div class="card-footer">
                                <div class="tools">
                                    <div class="btn-group">
                                        <a href="<?php echo site_url('admin/page/pages'); ?>" class="btn btn-default" role="button"><i class="icon ion-reply"></i> <?php echo lang('btn_back') ?></a>
