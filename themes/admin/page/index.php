                        ...
                        <div class="card card-line">
                            <div class="card-header">
                                <div class="card-header-title">
                                    <i class="icon ion-ios-photos"></i><?php echo lang('text_all_pages') ?>
                                </div>
                                <div class="tools">
                                    <div class="btn-group">
                                        <a href="<?php echo site_url('admin/page/pages/edit'); ?>" class="btn btn-primary" role="button"><i class="icon ion-compose"></i> <?php echo lang('btn_add') ?></a>
                            ...
                            <div class="card-body table-responsive">
                                <?php echo form_open('admin/page/pages/delete', 'id="form"'); ?>
                                    ...
                                    <table class="table table-striped table-hover" id="dataTables">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php echo lang('tbl_title_title') ?></th>
        ...
        $(function() {
            $('#dataTables').dataTable({
                "fnCreatedRow": function(nRow, aData, iDataIndex) {
                    ...
                    button = '<a href="' + baseurl + 'admin/page/pages/edit/' + id + '" class="btn btn-icon-toggle btn-default" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i class="icon ion-compose"></i></a>';
                    button += '<a href="' + baseurl + 'admin/page/pages/delete/' + id + '" class="btn btn-icon-toggle btn-default" data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="icon ion-trash-a"></i></a>';
                ...
                "fnDrawCallback": function(oSettings) {
                    ...
                    $('input[name="status"]').on('switchChange.bootstrapSwitch', function(event, state) {
                        $.ajax({
                            url: baseurl + 'admin/page/pages/status/' + $(this).attr('data') + '/' + state,
                            dataType: 'json',
                ...
                "bServerSide": true,
                "sAjaxSource": baseurl + "admin/page/pages/get_datatables"
            });
