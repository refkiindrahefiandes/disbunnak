                        ...
                        <div class="card card-line">
                            <div class="card-header">
                                <div class="card-header-title">
                                    <i class="icon ion-paintbrush"></i><?php echo lang('text_add_theme') ?>
                                </div>
                                <div class="tools">
                                    <div class="btn-group">
                                        <a href="<?php echo site_url('admin/theme/theme'); ?>" class="btn btn-default" role="button"><i class="icon ion-reply"></i> <?php echo lang('btn_back') ?></a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body" id="file-upload">
                                 <div class="text-center" style="padding: 30px 0">
                                    <div class="upload-ui">
                                        ...
                                        <h4 class="upload-instructions"><?php echo lang('text_upload_theme') ?></h4>
                                        <br>
...
<script>
    $(document).ready(function() {
        ...
        var uploadURI   = baseurl + 'admin/theme/theme/upload_theme';
