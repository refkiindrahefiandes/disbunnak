                ...
                <div class="row">
                    ...
                    <div class="card card-line">
                        <div class="card-header">
                            ...
                            <div class="tools">
                                <div class="btn-group">
                                    <a href="<?php echo site_url('admin/localisation/language/edit'); ?>" class="btn btn-primary" role="button"><i class="icon ion-compose"></i> <?php echo lang('btn_add') ?></a>
                        ...
                        <div class="card-body table-responsive">
                            <?php echo form_open('admin/localisation/language/delete','id="form"'); ?>
    ...
    $(function() {
        $('#dataTables').dataTable({
            "fnCreatedRow": function( nRow, aData, iDataIndex ) {
                ...
                var get_status = $('td:eq(5)', nRow).text();
                ...
                status    +=        '<label>';
                status    +=            '<input type="checkbox" name="status" class="switch-onoff" value="'+get_status+'" data="'+id+'" '+status_active+'>' ;
                status    +=        '</label>';
                status    +=    '</div>';

                button =  '<a href="'+baseurl+'admin/localisation/language/edit/'+id+'" class="btn btn-icon-toggle btn-default" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i class="icon ion-compose"></i></a>';
                button += '<a href="'+baseurl+'admin/localisation/language/delete/'+id+'" class="btn btn-icon-toggle btn-default" data-toggle="tooltip" data-placement="top" data-original-title="Delete"><i class="icon ion-trash-a"></i></a>';
            ...
            "fnDrawCallback": function( oSettings ) {
                ...
                $('input[name="status"]').on('switchChange.bootstrapSwitch', function(event, state) {
                    $.ajax({
                        url: baseurl + 'admin/localisation/language/status/' + $(this).attr('data') + '/' + state ,
                        dataType: 'json',
            ...
            "bServerSide": true,
            "sAjaxSource": baseurl+"admin/localisation/language/get_datatables"
        });
